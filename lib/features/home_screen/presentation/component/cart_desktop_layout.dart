import 'package:bn_website/core/general_components/custom_form_field.dart';
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          SizedBox(
            width: MediaQuery.of(context).size.width >= 1700 ? 1700 * 0.47 : MediaQuery.of(context).size.width * 0.40,
            height: MediaQuery.of(context).size.width >= 1700 ? 1700 * 0.47 : MediaQuery.of(context).size.width * 0.40,
